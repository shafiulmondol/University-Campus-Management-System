  ...
  <div class="navbar">
    <div class="navbar-top">
      <div class="logo">
        ...
        <h1>SKST University || Admission</h1>
      </div>

      <!-- Admission Login and Home Page Buttons -->
      <div style="display: flex; gap: 10px; flex-wrap: wrap; justify-content: center;">
        <a href="admission.php"><button class="admission-login">👉🏻 Apply Now</button></a>
