...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    // Check if staff exists with this email and password
    $sql = "SELECT id, first_name, last_name, email, department, position FROM stuf WHERE email = ? AND password = ?";
...
// If staff is logged in, get payment information
if (isset($_SESSION['staff_id'])) {
    ...
    // Fetch payment details from staff_payments table
    $sql = "SELECT * FROM staff_payments WHERE staff_id = ? ORDER BY created_at DESC";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$staff_id]);
...
<head>
    ...
    <title>Staff Payment Portal - SKST University</title>
...
<body>
        ...
        <div class="login-box">
            ...
            <form class="login-form" method="post">
                ...
                <div class="mt-3 text-center">
                    <p class="text-muted">Use your staff email and password to login</p>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 logo-container">
                    ...
                    <div>
                        ...
                        <h2 class="mb-0">Staff Payment Portal</h2>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="staff-info">
            <div class="row">
                <div class="col-md-8">
                    <h4>Welcome, <?php echo htmlspecialchars($_SESSION['staff_name']); ?></h4>
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-1"><strong>Staff ID:</strong> <?php echo htmlspecialchars($_SESSION['staff_id']); ?></p>
                            <p class="mb-1"><strong>Position:</strong> <?php echo htmlspecialchars($staff['position']); ?></p>
                        </div>
                        <div class="col-md-6">
                            <p class="mb-1"><strong>Email:</strong> <?php echo htmlspecialchars($_SESSION['staff_email']); ?></p>
                            <p class="mb-1"><strong>Department:</strong> <?php echo htmlspecialchars($staff['department']); ?></p>
                        </div>
                    </div>
                </div>
